<template>
      ...
      <div class="my-2">
              ...
              <div class="row slider-labels">
                ...
                <div class="col-xs-6 text-right caption"></div>
              </div>
              <div class="row">
                <div class="col-sm-12 d-flex">
                  <div>
                    <form>
                      <input type="hidden" name="min-value" value="" v-model="min" @change="saveStore()"/>
                      <input type="hidden" name="max-value" value="" v-model="max" @change="saveStores()"/>
                    </form>
                  </div>
                  <div class="d-flex w-100">
                    <div id="slider-range-value1"></div>
                    <div id="slider-range-value2" class="ms-auto"></div>
                  </div>
                </div>
              </div>
            </div>
      ...
      function closure(target, options) {
        ...
        function addMarking(spread, filterFunc, formatter) {
          ...
          function addSpread(offset, values) {
            ...
            out +=
              "<div " + getTags(offset, cssClasses[21], values) + "></div>";
